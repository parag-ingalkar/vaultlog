...
CREATE ROLE vaultlog_owner LOGIN PASSWORD 'vaultlog_owner_password' BYPASSRLS CREATEDB;
...
CREATE DATABASE vaultlog_test OWNER vaultlog_owner;
GRANT CONNECT ON DATABASE vaultlog_test TO vaultlog_app;
